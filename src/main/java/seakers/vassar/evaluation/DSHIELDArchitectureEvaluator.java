...
public class DSHIELDArchitectureEvaluator extends AbstractArchitectureEvaluator {
    ...
    public DSHIELDArchitectureEvaluator(ResourcePool resourcePool, AbstractArchitecture arch, String type) {
    ...
    public AbstractArchitectureEvaluator getNewInstance() {
        return new DSHIELDArchitectureEvaluator(super.resourcePool, super.arch, super.type);
    }

    @Override
    public AbstractArchitectureEvaluator getNewInstance(ResourcePool resourcePool, AbstractArchitecture arch, String type) {
        return new DSHIELDArchitectureEvaluator(resourcePool, arch, type);
    }
