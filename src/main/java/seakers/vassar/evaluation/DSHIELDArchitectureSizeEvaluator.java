...
public class DSHIELDArchitectureSizeEvaluator extends DSHIELDArchitectureEvaluator {
    protected ArrayList<SpacecraftDescription> designs;

    public DSHIELDArchitectureSizeEvaluator() {
    ...
    public DSHIELDArchitectureSizeEvaluator(ResourcePool resourcePool, AbstractArchitecture arch, String type) {
    ...
    public AbstractArchitectureEvaluator getNewInstance() {
        return new DSHIELDArchitectureSizeEvaluator(super.resourcePool, super.arch, super.type);
    }

    @Override
    public AbstractArchitectureEvaluator getNewInstance(ResourcePool resourcePool, AbstractArchitecture arch, String type) {
        return new DSHIELDArchitectureSizeEvaluator(resourcePool, arch, type);
    }
